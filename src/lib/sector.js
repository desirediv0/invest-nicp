import { agriculture, autocomponent, aviation, banking, biotechnology, cement, chemicals, consumerDurables, defenceManufacturing, eCommerce, educationTraining, engineeringCapitalGoods, esdm, financialServices, fmcg, gemsJewellery, healthcare, infrastructure, insurance, itBpm, manufacturing, mediaEntertainment, medicalDevices, metalsMining, msme, oilGas, pharmaceuticals, ports, power, railways, realestate, renewableEnergy, retail, roads, sciencetechnology, services, steel, telecommunications, textiles, tourismhospitality } from "@/assets"
import {
    GiFarmTractor,
    GiProcessor,
    GiCarWheel,
