import { agriculture, autocomponent, aviation, banking, biotechnology, cement, chemicals, consumerDurables, defenceManufacturing, eCommerce, educationTraining, engineeringCapitalGoods, financialServices, fmcg, gemsJewellery, healthcare, infrastructure, insurance, itBpm, manufacturing, mediaEntertainment, medicalDevices, metalsMining, msme, oilGas, pharmaceuticals, ports, power, railways, renewableEnergy, roads, sciencetechnology, telecommunications, textiles, tourismhospitality } from "@/assets"
import {
    GiFarmTractor,
    GiProcessor,
    GiCarWheel,
