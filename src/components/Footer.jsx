...
export default function BusinessFooter() {
  ...
  return (
    <footer
      ...
      style={{
        backgroundImage: `url('/science-technology.png')`,
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
              ...
              <div className="border-l-4 border-orange-500 pl-6">
                <Link href="/" className="flex items-center gap-3 mb-4">
                  <Image
                    ...
                    width={120}
                    height={120}
                    className="h-20 w-auto object-contain bg-white rounded-full p-1"
                  />
              ...
              <div className="pt-4 border-t border-gray-700">
                ...
                <div className="flex gap-3">
                  <a
                    ...
                    className="w-10 h-10 text-white bg-black flex items-center justify-center transition-colors border border-gray-600"
                  >
                    <FaXTwitter size={18} />
                  </a>
                  <a
            ...
            <div className="space-y-6">
              ...
              <nav className="space-y-2">
                <Link
                  href="/"
                  className="block text-gray-300 hover:text-orange-400 hover:bg-gray-800/50 px-4 py-2 transition-all duration-200 border-l-2 border-transparent hover:border-orange-500 text-sm font-medium"
                >
                  HOME
                </Link>
              ...
              <div className="mt-6">
                ...
                <div className="flex items-center justify-start">
                  <Link
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-block bg-white  border border-gray-200 shadow-sm"
                  >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
              <p className="text-center md:text-left text-sm text-gray-400">
                Copyright © 2023{" "}
                <span className="text-orange-400 font-semibold">NICP</span> -
                All Rights Reserved.
              </p>
