import { agriculture, autocomponent, automobiles, aviation, banking, biotechnology, cement, chemicals, consumerDurables, defenceManufacturing, eCommerce, educationTraining, engineeringCapitalGoods, financialServices, fmcg, gemsJewellery, healthcare, infrastructure, insurance, itBpm, manufacturing, mediaEntertainment, medicalDevices, metalsMining, msme, oilGas, pharmaceuticals, ports, power, renewableEnergy, sciencetechnology, telecommunications, textiles } from "@/assets"
import {
    GiFarmTractor,
    GiProcessor,
    GiCarWheel,
